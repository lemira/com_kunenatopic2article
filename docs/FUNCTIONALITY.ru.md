...
[⬅️ Назначение компонента, параметры, установка, функционирование](README.ru.md) | [ℹ️ Письма о создании статей, кодировка БД, плагин](ADDITIONAL.md)
...
- Обработка ссылок и изображений в строках напоминания
...
*[⬅️ Назначение компонента, параметры, установка, функционирование](README.ru.md) | [ℹ️ Письма о создании статей, кодировка БД, плагин](ADDITIONAL.ru.md)*
