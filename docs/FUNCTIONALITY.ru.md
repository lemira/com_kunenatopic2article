...
[⬅️ Назначение компонента, параметры, установка, функционирование](README.md) | [ℹ️ Письма о создании статей, кодировка БД, плагин](ADDITIONAL.md)
...
![Дерево связей постов в теме](images/Article_Topic_Tree.png "Дерево связей постов в теме")
